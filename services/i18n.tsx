...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'pur.approvalSheet': 'Purchase Approval Sheet',
    'pur.printApproval': 'Print Approval Sheet',
    'pur.smartRestock': 'Smart Restock',
    'pur.lowStockAlert': 'Low Stock Alert',
    'pur.createPO': 'Create PO',
    'pur.signature': 'Authorized Signature',
    'pur.manager': 'Purchasing Manager',
    'pur.ceo': 'CEO / Director',
    'pur.scanQuote': 'Scan Quote (AI)',
    'pur.scanning': 'AI is analyzing document...',
  ...
  th: {
    ...
    'pur.approvalSheet': 'ใบขออนุมัติสั่งซื้อ',
    'pur.printApproval': 'พิมพ์ใบขออนุมัติ',
    'pur.smartRestock': 'ระบบช่วยเติมของ (Smart Restock)',
    'pur.lowStockAlert': 'แจ้งเตือนสินค้าใกล้หมด',
    'pur.createPO': 'เปิดใบ PO ทันที',
    'pur.signature': 'ลายเซ็นผู้อนุมัติ',
    'pur.manager': 'ผู้จัดการฝ่ายจัดซื้อ',
    'pur.ceo': 'กรรมการผู้จัดการ',
    'pur.scanQuote': 'สแกนใบเสนอราคา (AI)',
    'pur.scanning': 'AI กำลังอ่านข้อมูลเอกสาร...',
  ...
  cn: {
    ...
    'pur.bestPrice': '最优惠价格',
    'pur.fastest': '最快交货',
    'pur.approvalSheet': '采购审批单',
    'pur.printApproval': '打印审批单',
    'pur.smartRestock': '智能补货',
    'pur.lowStockAlert': '库存不足警报',
    'pur.createPO': '创建 PO',
    'pur.signature': '授权签名',
    'pur.manager': '采购经理',
    'pur.ceo': '首席执行官',
    'pur.scanQuote': 'AI 扫描报价单',
    'pur.scanning': 'AI 正在分析文档...',
